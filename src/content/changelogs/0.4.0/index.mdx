...
The website's custom audio visualizer has been beefed up quite a bit. The most important changes
have been listed below. Not only that, you can now **try out this visualizer with ANY audio file\***
by heading to the new [visualizer playground](/misc/visualizer) page!<br /><small>\*: Assuming your
